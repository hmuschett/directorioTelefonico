...
use diretorioBundle\Entity\Departamento;
use diretorioBundle\Form\DepartamentoType;
...
class DepartamentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $departamentos = $em->getRepository('diretorioBundle:Departamento')->findAll();

        return $this->render('diretorioBundle:Departamento:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('diretorioBundle\Form\DepartamentoType', $departamento);
        ...
        return $this->render('diretorioBundle:Departamento:new.html.twig', array(
    ...
    public function showAction(Departamento $departamento)
    {
        ...
        return $this->render('diretorioBundle:Departamento:show.html.twig', array(
            'departamento' => $departamento,
    ...
    {
        $deleteForm = $this->createDeleteForm($departamento);
        $editForm = $this->createForm('diretorioBundle\Form\DepartamentoType', $departamento);
        ...
        return $this->render('diretorioBundle:Departamento:edit.html.twig', array(
            'departamento' => $departamento,
